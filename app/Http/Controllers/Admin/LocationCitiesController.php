...
class LocationCitiesController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        if ($vehicle) {
             return response()->json(['stateData' => $vehicle->state->state_name,'cityData' => $vehicle->city_name,'latitude' => $vehicle->latitude,'longitude' => $vehicle->longitude,'status' => $vehicle->status, 'idData' => $vehicle->id]);
         } else {
