                    ...
                    <div style="background: rgb(255, 255, 255);
                        ...
                        <div style="padding:12px !important" class="card-body ">
                            ...
                            <div class="item-card9-footer">
                                ...
                                {{-- <p  class="w-100 mt-2 mb-2 float-start" title="Mileage"><i
                                        class="fa fa-road text-muted me-1 "></i> {{ $inventory->miles == 0 ? 'TBD' : number_format($inventory->miles) . ' miles' }}</p> --}}
                                <p  class="w-100 mt-2 mb-2 float-start" title="Mileage"><img class="me-1" style="width:21px; height:21px; margin-top:-2px"
                                    src="{{ asset('/frontend/assets/images/miles.png') }}" alt="Used cars for sale for image Best Dream car mileage image"/> {{ $inventory->miles == 0 ? 'TBD' : number_format($inventory->miles) . ' miles' }}</p>
                        ...
                        <div class="card-footer pe-4 ps-4 pt-4 pb-4">
                            ...
                            <div class="item-card9-footer d-flex">
                                ...
                                @if($nameLength <= '25' ) <h5 class="dealer-add" style="color:black">{{ $cus_dealer }}
                                    ...
                                    <h5 title="{{$cus_dealer}}" class="dealer-add" style="color:black">{{ $name }}...
                                        <br>
                                        <span style="font-size:14px">{{ $inventory->dealer->city }}, {{
                                            strtoupper($inventory->dealer->state) }}
                                            {{ $inventory->zip_code }}
