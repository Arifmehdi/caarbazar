    ...
    <div class="container">
        <div>
            ...
            <div class="resharch-content-title">
                <h4 style="font-size:24px" class="mb-3">Selling your car</h4>
                ...
                <div class="row p-0" id="cars-containers">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-1">
                        <div style="width:100%" class="card">
                            <a href="{{route('article.details', $sel->id )}}" class="text-decoration-none">
                                <div class="">
                                    @if (isset($sel->img))
                                ...
                                <div class="mt-1 resh-tit p-3">
                                    <h5 style="margin-top:0px" class="fs-18  text-dark res-des-sell hyperlink-title">{{ $title }}
                                    </h5>
                                    <p style="height:80px" class="news-par">{{ $sub_title }}</p>
                                    <a class="mt-5 mb-0 res-more" href="{{route('article.details', $sel->id )}}"
...
<section style="margin-top:-45px" class="sptb bg-white">
    <div class="container">
        <div>
            @if($shops->count() > 1)
            <div class="resharch-content-title">
                <h4 style="font-size:24px" class="mb-3">Shopping & negotiating</h4>
            ...
            <div class="col-md-12 m-0 p-0">
                <div class="row p-0" id="cars-containers">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-5">
                        ...
                        <div style="width:100%" class="card">
                            <a href="{{route('article.details', $shop->id )}}" class="text-decoration-none">
                                <div class="">
                                ...
                                <div class="mt-1 resh-tit p-3">
                                    <h5 style="margin-top:0px" class="fs-18  text-dark res-des hyperlink-title">{{ $title }}</h5>
                                    <p style="height:80px;" class="res-par">{{ $sub_title }}</p>
                                    <a class="mt-5 mb-0 res-more" href="{{route('article.details', $shop->id )}}"
                                        style="float:right; color:darkcyan">Read more <i
                                            class="fa fa-angle-right ms-1 res-more"></i></a>
                                </div>
                            </a>
...
<section style="margin-top:-45px" class="sptb bg-white">
    <div class="container">
        <div>
            @if($owners->count() > 1)
            <div class="resharch-content-title">
                <h4 style="font-size:24px" class="mb-3">Ownership & maintenance</h4>
            ...
            <div class="col-md-12 m-0 p-0">
                <div class="row p-0" id="cars-containers">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-5">
                        <div style="width:100%" class="card">
                            <a href="{{route('article.details', $own->id )}}" class="text-decoration-none">
                                <div class="">
                                ...
                                <div class="mt-1  resh-tit p-3">
                                    <h5 style="margin-top:0px" class="fs-18  text-dark res-des hyperlink-title">{{ $title }}</h5>
                                    <p style="height:80px" class="news-par">{{ $sub_title }}</p>
                                    <a class="mt-5 mb-0 res-more" href="{{route('article.details', $own->id )}}"
                                        style="float:right; color:darkcyan">Read more <i
