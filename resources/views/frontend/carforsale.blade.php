                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6">
                                    <div class="card">
                                        ...
                                        <div class="item-card8-img  br-ts-7 br-bs-7">
                                            @if (isset($tip->img))
                                            <a href="{{ route('frontend.tips.details', ['id' => $tip->id]) }}">
                                                <img class="tips-img" style="width:100%; height:273px"
                                                src="{{ asset('/frontend/assets/images/tips/' .$tip->img) }}" alt="Used cars for sale dealer cars for sale ee image Best Dream car" onerror="this.onerror=null; this.src='{{ asset('frontend/NotFound.png') }}';"/>
                                            </a>
                                        ...
                                        <div class="card-body">
                                            <div class="item-card8-desc">
                                                ...
                                                <a class="text-dark" href="{{ route('frontend.tips.details', ['id' => $tip->id]) }}">
