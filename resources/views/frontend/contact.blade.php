...
<section id="error" class="section-padding-80 components">
    <div class="container">
        <div style="margin-top:65px; margin-bottom:150px" class="row">
            ...
            <div class="col-md-6 margin-bottom-40">
                <img style="margin-top:72px;" class="cont-img" src="{{asset('/frontend/assets/images/contact.jpg')}}"  alt="Used cars for sale Dream Best contact page contact image"/>

                <p class="mt-4">Our mission for the Best Dream car experience is to make auto financing quick and easy while providing a modern, hassle-free way of shopping for cars. Our innovative technology and proprietary financial tools provide consumers with the ability to instantly pre-qualify anywhere, anytime - without affecting their credit score.</p>
                <p>The Best Dream car experience offers consumers more transparency and insight into their purchasing options and empowers them to take control of their financing. Shoppers can structure a deal using down payment, term and monthly payment to find a car that aligns with their situation.</p>
