<body class="">
                                ...
                                <ul class="socials p-0 m-0">
                                    ...
                                    <li class="icon-item">
                                        <a target="_blank" class="social-icon" href="{{$file->link}}">
                                            <img src="{{asset('frontend/assets/images/links').'/'.$file->image}}" alt="{{$file->image}}"
                                                style="width:10px;" />
                                        </a>
                                    </li>
                                    @endforeach
                        ...
                        <div class="top-bar-right">
                            <ul class="custom">
                                ...
                                <li class="nav-item dropdown">
                                    <img style="border-radius:50%" src="{{ Auth::user()->image ? asset('frontend/assets/images/').'/'.Auth::user()->image : asset('/frontend/assets/images/profile.png') }}
                              " alt="Used cars for sale Best Dream car user image" height="28" width="28">
                                    <a style="padding:8px" class="nav-link dropdown-toggle" href="#" role="button"
                                    ...
                                    <ul class="dropdown-menu">
                                            ...
                                            <li class="me-2" style="width: auto;">
                                                <a href="{{  $url }}">
                                                    <img style="border-radius:50%" class="ms-1"
                                                        ...
                                                        alt="User profile image" height="25" width="25">
                                                </a>
                                            </li>
                                            <li style="width: auto;">
                                                <a href="{{  $url }}">{{(Auth::user()->name) ? Auth::user()->name :
                                                    Auth::user()->email}} </a>
                                            </li>
                                        ...
                                        <li><a style="font-size:15px; margin-left:4px; color:rgb(68, 68, 68);padding-left:10px"
                                                class="dropdown-item mb-2"
                                                href="{{ route('buyer.cargarage.show') }}">Cargarage</a></li>
                                        @endif
                                        @if (auth()->check() && auth()->user()->hasAnyRole(['admin', 'editor',
                                        'dealer']))
                                        <li><a style="font-size:15px;margin-left:4px; color:rgb(68, 68, 68);padding-left:10px"
                                                class="dropdown-item mb-2" href="{{ $url }}">Administrator </a></li>
                                        @else
                                        <li><a style="font-size:15px;margin-left:4px; color:rgb(68, 68, 68);padding-left:10px"
                                                class="dropdown-item mb-2" href="{{ $url }}">Account Information</a>
                                        </li>
                                        @endif
                                        <hr style="margin-top:3px; margin-bottom:9px">
                                        <li><a style="font-size:15px; margin-left:4px; color:rgb(68, 68, 68);padding-left:10px"
                                                class="dropdown-item mb-2" href="{{ route('buyer.logout')}}">Log out</a>
                                        </li>
                                    </ul>
                                </li>
                                @else
                                <li>
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"
                                        class="text-dark"><i class="fa fa-sign-in me-1"></i> <span>Login</span></a>
                                </li>
                                @endif
                            </ul>
                        </div>
            ...
            <div class="container">
                ...
                <a href="{{ route('home')}}">
                    <span class="smllogo">
                        ...
                        @else
                        <img src="{{ asset('frontend/assets/images/car77.png') }}" width="120" alt="Default image">
                        @endif
                    </span>
            ...
            <div class="container clearfix horizontal-mainwrapper">
                ...
                <nav class="clearfix horizontalMenu d-md-flex">
                    <ul class="horizontalMenu-list">
                        ...
                        <li style="margin-top: 2px;" aria-haspopup="true">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li aria-haspopup="true">
                                    @if ($submenu->param)
                                    <a
                                        href="{{ route($submenu->route_url, ['body' => $submenu->param,'home'=>true]) }}">{{
                                        $submenu->name }}</a>
                                    @else
                        ...
                        @if (!auth()->check() || (auth()->check() && auth()->user()->hasAnyRole(['admin', 'editor',
                        'dealer'])))
                        <li style="margin-top:2px;" aria-haspopup="true">
                            <a style="color:black" href="{{ route('favourite.listing') }}">Favorites</a>
                        </li>
                        @endif
                        ...
                        <div style="position: relative; width: 400px; float: right; margin-top: 24px;" class="search-content-manage">
    <form id="searchForm" action="{{ route('search') }}" method="GET" style="margin: 0;">
        ...
        />
        <i
            style="position: absolute; left: 20px; top: 50%; transform: translateY(-50%); color: rgb(10, 10, 10);"
            class="fa fa-search search-icon-topbar"
        ></i>
    </form>
</div>
                        ...
                        <div class="col-lg-12 col-xl-12">
                            <div class="mb-3 row " id="rowOne">
                                <div style="text-align:center" class="tab-1 col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                    ...
                                    <p style="text-align: center !important; margin-top:23px">Continue with email or
                            ...
                            left:-207px; cursor:pointer;" class="fa fa-angle-left previous_link-signup"
                                    onclick="GoBack(5)"></i>
                             ...
                             margin-right:58px ; font-size:12px; margin-top:10px">Your password must be at least 8
