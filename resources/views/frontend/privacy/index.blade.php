...
{{--@section('og_title')
Terms and Condition | Best Used Cars for Sale - bestdreamcar.com®
@endsection
        ...
        <div class="header-text mb-0">
            <div class="container">
                <div class="text-center text-white">
                    <h1 class="favorite-header">Terms and Conditions</h1>
                    ...
                    <ol class="breadcrumb text-center">
                        ...
                        <li  class="favorite-bc"><a style="color:white" href="javascript:void(0);">Terms and Conditions of Use</a></li>
