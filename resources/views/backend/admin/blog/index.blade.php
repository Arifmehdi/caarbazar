                    ...
                    <form action="{{ route('admin.blog.add') }}" method="post" id="blogAdd"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="type" id="type">
                                ...
                                <option value="Selling your car">Selling your car</option>
                                <option value="Shopping & negotiating">Shopping & negotiating</option>
                                <option value="Ownership & maintenance">Ownership & maintenance</option>
                    ...
                    buttons: {
                        ...
                        confirm: {
                            ...
                            action: function() {
                                ...
                                $.ajax({
                                    url: "{{ route('admin.single.blog.delete') }}",
                                    type: 'post',
                                    data: {
                                        id: id
                                    },
